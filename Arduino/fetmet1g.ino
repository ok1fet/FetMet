 /*////////////////////////////////////////////////////////////////////////////////////////////
  ...
  | |_  |  _|   | |_____| |\/| |  _|   | |  
  |  _| | |___  | |_____| |  | | |___  | |  
  |_|   |_____| |_|     |_|  |_|_____| |_|  Metostanice LoRa verze 1.g
...
const char* rstv = "000/000g000r000_RESETg";     // idetifikace ze doslo k reset sondy + verse sw pro orientaci
/////////////////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////////////////  
 ...
 rainCount5min++;
 if (rainCount5min % 10 == 0) {
    rainCount5min++;  // navýšení o 1 navíc při 10, 20, 30...kompenzace prutrze mracen
  }
